    ...
    <el-row :gutter="30">
      ...
      <re-col>
        <el-form-item label="上级菜单">
          <el-cascader v-model="newFormInline.parentId" class="w-full" :options="parentResources" :props="{
    value: 'id',
    label: 'title',
    emitPath: false,
    checkStrictly: true
      ...
      <re-col :value="12" :xs="24" :sm="24">
        <el-form-item label="菜单排序">
          <el-input-number v-model="newFormInline.rank" class="!w-full" :min="1" :max="9999"
      ...
      <re-col v-if="newFormInline.type === 3" :value="12" :xs="24" :sm="24">
        ...
        <el-form-item label="权限标识" prop="auths">
          <el-input v-model="newFormInline.permissionCode" clearable placeholder="请输入权限标识" />
        </el-form-item>
      </re-col>
      ...
      <re-col v-if="newFormInline.type === 1" :value="12" :xs="24" :sm="24">
        <el-form-item label="加载动画">
          <Segmented :modelValue="newFormInline.frameLoading ? 0 : 1" :options="frameLoadingOptions" @change="({ option: { value } }) => {
    ...
    " />
      ...
      <re-col v-show="newFormInline.type < 2" :value="12" :xs="24" :sm="24">
        <el-form-item label="缓存页面">
          <Segmented :modelValue="newFormInline.keepAlive ? 0 : 1" :options="keepAliveOptions" @change="({ option: { value } }) => {
    ...
    " />
      ...
      <re-col v-show="newFormInline.type !== 3" :value="12" :xs="24" :sm="24">
        <el-form-item label="菜单">
          <Segmented :modelValue="newFormInline.showLink ? 0 : 1" :options="showLinkOptions" @change="({ option: { value } }) => {
    ...
    " />
      ...
      <re-col v-show="newFormInline.type !== 3" :value="8" :xs="24" :sm="24">
        <el-form-item label="父级菜单">
          <Segmented :modelValue="newFormInline.showParent ? 0 : 1" :options="showParentOptions" @change="({ option: { value } }) => {
